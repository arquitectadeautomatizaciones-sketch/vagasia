...
export default function DemoPage() {
  return (
    <div className="p-6 space-y-6">
      ...
      {/* 3-col grid: Clientes · Fidelização · Aniversários + Satisfação */}
            ...
            <div className="p-4 space-y-3">
              {[
                ...
                <div key={k.label} className="space-y-1.5">
                  ...
                  <div className="h-1.5 rounded-full bg-white/5 w-full overflow-hidden">
                    <div className="h-full rounded-full" style={{ width: `${(k.value / 5) * 100}%`, backgroundColor: k.value >= 4.5 ? "#2DD4BF" : "#00B4D8" }} />
                  </div>
                </div>
              ))}
            </div>
